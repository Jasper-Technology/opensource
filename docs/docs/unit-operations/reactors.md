...
Jasper supports seven reactor types. Quick mode uses stoichiometric and equilibrium shortcut models; Rigorous mode uses DWSIM's CSTR / PFR / Equilibrium / Gibbs / Conversion reactor unit operations.
